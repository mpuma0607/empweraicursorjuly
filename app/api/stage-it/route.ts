...
export async function POST(req: Request) {
  ...
  try {
    ...
    const prompt = [
      ...
      `- DO NOT change, move, resize, remove, or modify ANY windows, doors, or openings`,
      `- DO NOT alter window frames, door frames, trim, molding, or structural elements`,
      `- DO NOT change the size, shape, position, or proportions of ANY existing features`,
      ...
      `- Keep all existing walls, flooring, ceiling, and structural features IDENTICAL`,
      `- Windows must remain in exact same position, size, and appearance`,
      `- Only add furniture, decor, lighting, and staging elements to the existing space`,
