      ...
      try {
        ...
        if (brandingProfile) {
          ...
          const brandColors: Record<string, { primary: string; secondary?: string }> = {
            ...
            kw: { primary: "#cc0000", secondary: "#ffffff" },
            ...
            realty: { primary: "#DAA520", secondary: "#000000" },
            ...
            douglas: { primary: "#000000", secondary: "#4B9CD3" },
            howard: { primary: "#228B22", secondary: "#FFD700" },
            windermere: { primary: "#000000", secondary: "#1B365D" },
            era: { primary: "#DC143C", secondary: "#1B365D" },
            properties: { primary: "#000000", secondary: "#DC143C" },
            weichert: { primary: "#ffd700", secondary: "#000000" },
            united: { primary: "#1B365D", secondary: "#ffffff" },
            home: { primary: "#DC143C", secondary: "#000000" },
          }
