...
const pages = [
  {
    id: 1,
    title: "Email & Photo Setup",
    image: "/images/gsuite-setup-page1.png",
    description: "Set up your company email and add your profile photo",
  },
  {
    id: 2,
    title: "Signature & Mobile",
    image: "/images/gsuite-setup-page2.png",
    description: "Create your email signature and set up mobile access",
  },
]

export function GSuiteSetupViewer() {
    ...
    <div className="flex flex-col h-full">
      ...
      <div className="flex items-center justify-between p-4 border-b bg-gray-50">
        <div className="flex items-center gap-4">
          <h3 className="text-lg font-semibold">G-Suite & Email Setup</h3>
        ...
        <div className="flex justify-center">
          <div style={{ transform: `scale(${zoom / 100})` }} className="transition-transform duration-200 origin-top">
            <Image
              ...
              alt={`G-Suite setup guide page ${currentPage}: ${currentPageData?.description}`}
              width={1200}
              height={800}
      ...
      <div className="p-4 border-t bg-blue-50">
        <div className="text-sm text-blue-800 space-y-1">
          <p>
            <strong>Page 1:</strong> Company email setup, 2-step verification, profile photo
          </p>
          <p>
            <strong>Page 2:</strong> Email signature creation, mobile Gmail setup
          </p>
        </div>
      </div>
    </div>
